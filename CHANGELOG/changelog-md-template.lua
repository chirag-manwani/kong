...
> for scope, entries in pairs(enterprise.breaking_changes or {}) do
#### ${scope}
...
> for scope, entries in pairs(enterprise.deprecations or {}) do
>   render_changelog_entries(entries)
> end
...
> for scope, entries in pairs(enterprise.dependencies or {}) do
>   render_changelog_entries(entries)
> end
...
> for scope, entries in pairs(enterprise.features or {}) do
#### ${scope}
>   render_changelog_entries(entries)
> end
...
> for scope, entries in pairs(enterprise.bugfixes or {}) do
#### ${scope}
>   render_changelog_entries(entries)
> end
